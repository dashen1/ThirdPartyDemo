...
public class DownloadFileDao extends AbstractDao<DownloadFile, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Process = new Property(3, Long.class, "process", false, "PROCESS");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DOWNLOAD_FILE\" (" + //
                ...
                "\"START\" INTEGER UNIQUE ," + // 1: start
                "\"END\" INTEGER," + // 2: end
                "\"PROCESS\" INTEGER);"); // 3: process
    }
    ...
    public DownloadFile readEntity(Cursor cursor, int offset) {
        DownloadFile entity = new DownloadFile( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getLong(offset + 3) // process
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, DownloadFile entity, int offset) {
        ...
        entity.setProcess(cursor.isNull(offset + 3) ? null : cursor.getLong(offset + 3));
     }
