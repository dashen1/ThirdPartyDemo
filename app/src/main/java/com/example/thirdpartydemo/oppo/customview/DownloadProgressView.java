package com.example.thirdpartydemo.oppo.customview;
...
//        }
    ...
    private void drawText(Canvas canvas) {
        ...
        String textContent = retainOneDecimal(getProgressRatio() * 100) + "%";
        //计算文字Y轴坐标
    ...
    private float retainOneDecimal(float original) {
        return (float) (Math.round(original * 10)) / 10;
    }
    ...
    /**
     * 获取当前进度值比值
     * (long) mProgressBar.getProgress() * 100 / mProgressBar.getMax()
     */
